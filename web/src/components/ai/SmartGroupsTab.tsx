...
import { AlertTriangle, ChevronDown, ChevronRight, Sparkles, Wrench, XCircle } from "lucide-react";
...
export default function SmartGroupsTab({
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-right text-xs text-content-faint">Generated by Claude AI · Review before bulk-triaging</p>
    </div>
  );
}
